...
### 섹터/국가/통화 노출
Look-through 결과를 차원별로 재집계. `backend/sector_labels.py`가 영문 GICS 섹터를 한국어 라벨로 정규화(IT / 반도체 / 바이오 / 금융 / 2차전지 / 기타). NVDA·005930 등 반도체 본업 종목은 ticker 기반 오버라이드로 격상.
...
운영 URL: `https://lux-ru-xtymbd36rq-du.a.run.app`
